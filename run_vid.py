...
def define_arguments():
	...
	parser.add_argument('--clinical_test', '-ct', default= 'clinical_test', type = str, help = 'The column indicates the infection status in clinical assessment.(Sample level)')
