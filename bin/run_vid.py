...
def define_arguments():
	...
	parser.add_argument('--fs_iter', '-fi', default = 100, type = int, help = 'The number of iteration applied in feature selection.')
	parser.add_argument('--n_iter', '-ni', default = 50, type = int, help = 'Number of iteration applied in randomsearchcv.')
